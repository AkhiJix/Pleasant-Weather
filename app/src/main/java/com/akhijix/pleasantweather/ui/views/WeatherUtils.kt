...
import com.akhijix.pleasantweather.data.enums.WeatherType
...
object WeatherUtils {
    ...
    private fun getWeatherType(id: Int): WeatherType {
        return when (id) {
            ...
            in 300..321, in 500..504, in 520..531 -> WeatherType.RAINY
            511, in 600..602, in 611..622 -> WeatherType.SNOWY
